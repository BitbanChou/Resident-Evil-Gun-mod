package com.joy187.re8gun.entity.render;
...
public class RenderGM79B extends EntityRenderer<EntityGM79B> {
    ...
    public RenderGM79B(EntityRendererProvider.Context manager) {
    ...
    public void render(EntityGM79B entityIn, float entityYaw, float partialTicks, PoseStack poseStackIn, MultiBufferSource bufferIn, int packedLightIn) {
